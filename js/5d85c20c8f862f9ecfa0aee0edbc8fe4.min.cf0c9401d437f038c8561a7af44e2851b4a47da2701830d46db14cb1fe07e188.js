...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ke,depthTest:!1,depthWrite:!1});return a}function lh(){return new Ge({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Rr(),fragmentShader:`
		...
		`,blending:Ke,depthTest:!1,depthWrite:!1})}function dh(){return new Ge({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Rr(),fragmentShader:`
		...
		`,blending:Ke,depthTest:!1,depthWrite:!1})}function Rr(){return`
...
#define LOW_PRECISION`),t}function Qm(e){let t="SHADOWMAP_TYPE_BASIC";return e.shadowMapType===dc?t="SHADOWMAP_TYPE_PCF":e.shadowMapType===vu?t="SHADOWMAP_TYPE_PCF_SOFT":e.shadowMapType===he&&(t="SHADOWMAP_TYPE_VSM"),t}function Zm(e){let t="ENVMAP_TYPE_CUBE";if(e.envMap)switch(e.envMapMode){case Ut:case Kt:t="ENVMAP_TYPE_CUBE";break;case Qn:t="ENVMAP_TYPE_CUBE_UV";break}return t}function Jm(e){let t="ENVMAP_MODE_REFLECTION";if(e.envMap)switch(e.envMapMode){case Kt:t="ENVMAP_MODE_REFRACTION";break}return t}function e8(e){let t="ENVMAP_BLENDING_NONE";if(e.envMap)switch(e.combine){case Xa:t="ENVMAP_BLENDING_MULTIPLY";break;case Wd:t="ENVMAP_BLENDING_MIX";break;case $d:t="ENVMAP_BLENDING_ADD";break}return t}function t8(e){const t=e.envMapCubeUVHeight;if(t===null)return null;const n=Math.log2(t)-2,s=1/t,o=1/(3*Math.max(Math.pow(2,n),7*16));return{texelWidth:o,texelHeight:s,maxMip:n}}function n8(e,t,n,s){const o=e.getContext(),k=n.defines;let a=n.vertexShader,c=n.fragmentShader;const y=Qm(n),w=Zm(n),j=Jm(n),E=e8(n),u=t8(n),C=Rm(n),f=Pm(k),i=o.createProgram();let d,l,b=n.glslVersion?"#version "+n.glslVersion+`
